               ...
               if (iface = obj[msg['interface']]) {
                   ...
                   try {
                       ...
                       if(typeof result === "function") {
                           //thunk?
                           return result(function(err, result){
                               if(err) {
                                    return self.sendError(msg, err.name, err.message);
                               }
                               self.sendReply(msg, resultSignature, [result]);
                           }
                       }
                   } catch (e) {
                       return self.sendError(msg, e.name, e.message);
